...
import { bookmarklet } from '@/lib/tabImport'
import { Sparkle } from '@/components/Logo'
import { useTitle } from '@/hooks/useTitle'

/** How to bring a tab over from another site. */
export function ImportPage() {
  const link = useRef<HTMLAnchorElement>(null)
  useTitle('Import a tab')
  ...
  return (
    <div className="flex max-w-2xl flex-col gap-6 pt-1">
      <div>
        <h1 className="text-3xl font-black tracking-tight">Import a tab</h1>
      ...
      <ol className="flex flex-col gap-4">
        ...
        <li className="card flex flex-col gap-2 p-5">
          <span className="font-black">2. Open a chords or tab page and click it</span>
          <span className="font-semibold text-ink-soft">
      ...
      <p className="flex items-center gap-2 font-semibold text-ink-soft">
        ...
        <span>
          ...
          . Chords written above the lyrics, or in [ch]…[/ch] chord-tag markup, get converted for you.
        </span>
      </p>
    </div>
  )
